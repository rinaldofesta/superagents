...
export const GenerationContextSchema = z.object({
  ...
  (data) => data.authMethod !== 'api-key' || data.apiKey,
  { message: 'API key is required when using api-key auth method' }
);
 ...
 */
export function validateGenerationContext(context: unknown): ValidatedGenerationContext {
 ...
 */
export function safeValidateGenerationContext(context: unknown): z.SafeParseReturnType<unknown, ValidatedGenerationContext> {
 ...
 */
export function validateProjectGoal(goal: unknown): ValidatedProjectGoal {
 ...
 */
export function validateCLIOptions(options: unknown): ValidatedCLIOptions {
